...
class BatteryApplication : Application() {
    ...
    override fun onCreate() {
        ...
        SafeModeInitializer.runSafeTask("EngineCoordinator") {
            ...
            com.example.engines.coordinator.EngineCoordinator.registerEngine(com.example.engines.coordinator.NetraMultiMechanismCoordinator)
            ...
            kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO + kotlinx.coroutines.SupervisorJob()).launch {
                try {
                    ...
                    if (dao != null) {
                        ...
                        val newVersionCode = (existingVersion?.versionCode?.coerceAtLeast(306) ?: 306) + 1
                        val newVersionName = "3.3.0-sql-build-$newVersionCode"
